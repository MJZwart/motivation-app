...
export const POWER = 'material-symbols:power-rounded';

export const QUESTION = 'mdi:question-mark-circle-outline';

export const LOCK = 'mingcute:lock-fill';
export const UNLOCK = 'mingcute:key-2-fill';
export const BAN = 'mingcute:auction-fill';
export const REPORT = 'ic:round-report-gmailerrorred';

export const NEW = 'mdi:new-releases';

export const REPEAT = 'mi:repeat';
export const RESET = 'fa:repeat';
