<template>
    <div class="w-60-flex center row">
        <ResponsiveTabs>
            <button :class="activeTab('AccountSettings')" class="tab-item" @click="switchTab('AccountSettings')">
                {{ $t('account-settings') }}
            </button>
            <button :class="activeTab('ProfileSettings')" class="tab-item" @click="switchTab('ProfileSettings')">
                {{ $t('profile-settings') }}
            </button>
            <button :class="activeTab('RewardSettings')" class="tab-item" @click="switchTab('RewardSettings')">
                {{ $t('reward-settings') }}
            </button>
        </ResponsiveTabs>
...
onMounted(async () => {
    ...
    else tabKey.value = 'AccountSettings';
