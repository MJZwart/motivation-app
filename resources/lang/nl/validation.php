...
return [
    ...
    */
    ...
    'after'                => ':attribute moet een datum zijn na die van :date.',
    'after_or_equal'       => ':Attribute moet een datum zijn na of gelijk aan :date.',
    'alpha'                => ':attribute kan alleen uit letters bestaan.',
    ...
    */
    ...
    'custom' => [
        ...
        // ],
        'days' => [
            'min' => 'Het aantal dagen moet meer zijn dan 1 als je niet kiest voor onbepaalde tijd.',
            'required_if' => 'Als je de schorsing niet opheft, vul dan het aantal dagen in.'
        ],
        'indefinite' => [
            'required_if' => 'Als je geen dagen hebt ingevoerd, kies dan voor onbepaalde tijd.'
        ],
        'agree_to_tos' => [
            'accepted' => 'Je moet het eens zijn met de servicevoorwaarden om een account aan te maken.',
        ],
        'email' => [
            'required_without' => 'Vul een e-mailadres in zodat we contact met je op kunnen nemen als we verdere vragen of opmerkingen hebben.',
        ],
        'keepOldInstance' => [
            'required' => 'Selecteer of je een bestaande karakter of nederzetting wil activeren of een nieuwe aanmaken.',
        ],
        'achievement_type' => 'Ongeldig achievement type.',
        'match_old_password' => 'Oude wachtwoord is incorrect.',
        'valid_bug_type' => 'Je hebt geen geldig bug type geselecteerd.',
        'valid_repeatable' => 'Dit is geen geldig herhaalbaar type.',
        'valid_reward_type' => 'Dit is geen geldig beloningstype.',
        'valid_task_type' => 'Dit is geen geldig taak type.',
    ],
